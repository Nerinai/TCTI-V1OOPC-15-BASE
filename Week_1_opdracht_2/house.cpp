...
house::house( window & w, int coord_x, int coord_y, float scale, int ishome):
	ishome (ishome),
	...
	roof(w, coord_x - 1 , coord_y, (coord_x + (20 * scale) + 1), coord_y, coord_x + (10 * scale), coord_y - ((20 / 2) * scale) - 1),
